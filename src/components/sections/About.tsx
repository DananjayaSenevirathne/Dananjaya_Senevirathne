  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <h2 className="select-none font-display text-[15vw] italic text-black/[0.03]">
          Who I'm
        </h2>
      </div>
      ...
      <div className="relative z-10 grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 md:col-span-9">
          <motion.h2
            ...
            className="font-display text-[4rem] italic leading-none tracking-[-0.05em] md:text-[8rem]"
          >
            Who I'm
          </motion.h2>
        </div>
      ...
      <div className="relative z-10 mt-24 grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 md:col-span-9">
          <p className="font-display text-3xl leading-[1.15] md:text-4xl">
            {words.map((word, i) => (
              <motion.span
                key={i}
      ...
      {/* Traits */}
{/* Skills Marquee */}
<div className="relative z-10 mt-32 overflow-hidden border-y border-border py-10">
  <motion.div
    animate={{
      x: ["0%", "-50%"],
    }}
